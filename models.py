...
class NearEarthObject:
    ...
    def __init__(self, designation: str, name: str = None, diameter='nan', hazardous: bool = False):
        ...
        :param hazardous: A collection of this NearEarthObject close approach to Earth.
        """
...
class CloseApproach:
    ...
    def __init__(self, designation: str, time: str = None, distance: float = 0.0, velocity: float = 0.0, neo=None):
        ...
        :param designation: Thr 
        :param time: The date and time, in UTC, at which the NEO passes closest to Earth.
        :param distance: The nominal approach distamnce, in astronomical units, of the NEO to Earth at the closest point.
        :param velocity: The velocity, in kilometers per second, of the NEO to Earth at the closes point.
    ...
    def __str__(self):
        ...
        # The project instructions include one possibility. Peek at the __repr__
        # method for examples of advanced string formatting.
        return f"At {self.time_str}, {self.neo} approaches Earth at a distance of {self.distance} au and a velocity of {self.velocity} km/s."
