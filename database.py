...
objects and their close approaches.
...
class NEODatabase:
    ...
    def __init__(self, neos, approaches):
        ...
        them together - after it's done, the `.approaches` attribute
        of each NEO has a collection of that NEO's close approaches,
        and the `.neo` attribute of each close approach references
        the appropriate NEO.
        ...
        for approach in self._approaches:
            neo = next((neo for neo in self._neos
                        if neo.designation == approach._designation), None)
    ...
    def get_neo_by_designation(self, designation):
        ...
        """
        neo = next((neo for neo in self._neos
                    if neo.designation == designation), None)
        return neo
    ...
    def get_neo_by_name(self, name):
        ...
        """
        neo = next((neo for neo in self._neos if neo.name == name), None)
        return neo
